...
var HTMLlocation = '<li class="flex-item"><span class="orange-text">location</span><a href="#">%data%</a></li>';
...
function initializeMap() {
  ...
  */
  function locationFinder() {
	...
	*/
	uniqueLocations.push("Kilis, Turkey");
	uniqueLocations.push("Gaziantep, Turkey");
	uniqueLocations.push("Azaz, Syria");
	uniqueLocations.push("Alepo, Syria");
	uniqueLocations.push("Istanbul, Turkey");
	uniqueLocations.push("Suruc, Turkey");
	uniqueLocations.push("Kobani, Turkey");
